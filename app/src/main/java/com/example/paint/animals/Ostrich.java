...
public class Ostrich extends AppCompatActivity {
    ...
    int IDs[] = {
            R.drawable.ostrich_1,
            R.drawable.ostrich_2,
            R.drawable.ostrich_3,
            R.drawable.ostrich_4,
            R.drawable.ostrich_5,
            R.drawable.ostrich_6,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViews();
        picsQty();
        imgShow.setImageResource(R.drawable.ostrich_6);
